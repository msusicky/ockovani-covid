...
from app.models import Nakazeni65Ockovani


class Infected65VaccinatedFetcher(Fetcher):
    """
    Class for updating infected 65+ table.
    """

    INFECTED_CSV = 'https://onemocneni-aktualne.mzcr.cz/api/v2/covid-19/ockovani-pozitivni65.csv'

    def __init__(self):
        super().__init__(Nakazeni65Ockovani.__tablename__, self.INFECTED_CSV)
