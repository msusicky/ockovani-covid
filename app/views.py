...
def statistiky_ockovani():
    ...
    return render_template('statistiky_ockovani.html', last_update=_last_import_modified(), now=_now(), metriky=metriky,
                           end_date=end_date, end_date_supplies=end_date_supplies,
                           end_date_interested=end_date_interested, interest=interest, vaccines=vaccines,
                           vaccinated=vaccinated, vaccinated_category=vaccinated_category,
                           reservations_category=reservations_category, supplies=supplies,
...
def statistiky_srovnani():
    ...
    return render_template('statistiky_srovnani.html', last_update=_last_import_modified(), now=_now(), metriky=metriky,
                           end_date=end_date, end_date_supplies=end_date_supplies,
                           end_date_interested=end_date_interested, interest=interest, vaccines=vaccines,
                           vaccinated=vaccinated, vaccinated_category=vaccinated_category,
                           reservations_category=reservations_category, supplies=supplies,
...
def statistiky_nemocnice():
    ...
    return render_template('statistiky_nemocnice.html', last_update=_last_import_modified(), now=_now(), metriky=metriky,
                           end_date=end_date, end_date_supplies=end_date_supplies,
                           end_date_interested=end_date_interested, interest=interest, vaccines=vaccines,
                           vaccinated=vaccinated, vaccinated_category=vaccinated_category,
                           reservations_category=reservations_category, supplies=supplies,
